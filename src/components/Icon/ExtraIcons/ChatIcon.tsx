export const ChatIcon = (active: boolean, isHover?: boolean) => {
  return (
    <svg
      width='24'
      height='24'
    ...
    >
      <path
        ...
        stroke={isHover ? 'none' : '#002366'}
        fill={active ? (isHover ? '#8997B2' : '') : isHover ? '' : 'none'}
        strokeWidth='1.5'
        strokeMiterlimit='10'
        strokeLinecap='round'
      ...
      <path
        ...
        stroke={active ? '#002366' : 'none'}
        fill={active ? (isHover ? '#002366' : '') : isHover ? '' : 'none'}
        strokeWidth='1.5'
        strokeMiterlimit='10'
        strokeLinecap='round'
        strokeLinejoin='round'
